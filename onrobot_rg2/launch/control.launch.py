"""Launch the RG2 ros2_control stack with real, fake, or Isaac hardware."""
...
def generate_launch_description():
    """Bring up a real RG2 through the standard ros2_control stack."""
    ...
    share = FindPackageShare('onrobot_rg2')
    description = ParameterValue(Command([
        'xacro ', PathJoinSubstitution([
            share, 'urdf', 'realmesh_onrobot_rg2.urdf.xacro'
        ]),
        ' host:=', host,
        ' port:=', port,
        ' transport:=', transport,
